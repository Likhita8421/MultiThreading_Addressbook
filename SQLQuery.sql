...
--UC-1-ADO.NET----ADDING DATA-----
GO 
CREATE PROCEDURE [dbo].[ADDING DATA]
(
...
AS
BEGIN
INSERT INTO ADDRESS_BOOK VALUES(@FIRST_NAME, @LAST_NAME,@ADDRESS, @CITY,@STATE,@ZIP,@PhoneNO,@EMAIL,@Type)
END
...
AS
BEGIN
UPDATE ADDRESS_BOOK SET ID = 3, ADDRESS = '540/98 Subodh Nagar' WHERE ID=@ID
END
